...
def Run(ct,*args):
  ...
  suff = "plan_test/all_rwd"+"/"
  src_core = '/home/yashima/ros_ws/ay_tools/ay_skill_extra/mysim/logs/' \
          + "bottomup/learn7/choose/bounce/random/first"+"/"
  ...
  l.custom_mtr = "nobounce" #random or any material or tuple material
  l.custom_smsz = 0.08    #random or 0.03~0.08 or tuple smsz
  l.delta_smsz = 0.0
  ...
  ct.Run("mysim.bottomup.learn7_main_tmp", l)