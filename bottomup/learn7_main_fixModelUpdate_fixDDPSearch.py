...
def Update(l,dynamics,xs_prev,xs_latest):
  l.dpl.MM.Models[dynamics][2].Load(data={"params": {"nn_params":None,"nn_params_err":None}},base_dir=l.dpl.MM.Models[dynamics][2].load_base_dir)
  l.dpl.MM.Models[dynamics][2].Init()
  l.dpl.MM.Models[dynamics][2].Options.update(l.nn_options)
  l.dpl.MM.Update(dynamics,xs_prev,xs_latest, not_learn=l.not_learn)
...
def Execute(ct,l):
  ...
  while True:  #Try-and-error starts from here.
    ...
    with sim.TPause(ct):  #Pause during plan/learn
      ...
      Update(l,"Fmvtopour2",l.xs.prev,l.xs.n2b)
    ...
    if selected_skill=='std_pour':
      ...
      with sim.TPause(ct):  #Pause during plan/learn
        ...
        Update(l,"Fflowc_tip10",xs_in,l.xs.n4ti)
      ...
      with sim.TPause(ct):  #Pause during plan/learn
        ...
        Update(l,"Fflowc_shakeA10",xs_in,l.xs.n4sa)
