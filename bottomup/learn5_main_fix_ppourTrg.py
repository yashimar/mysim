...
def Execute(ct,l):
  ...
  with sim.TPause(ct):
    ...
    l.xs.n0['p_pour_trg']= SSA(Vec([0.42+0.06*(random.random()-0.5),0.4+0.06*(random.random()-0.5)]))
    l.xs.n0['dtheta1']= SSA([0.014])
    # l.xs.n0['dtheta2']= SSA([0.004])
    l.xs.n0['dtheta2']= SSA([0.005])
...
def Run(ct,*args):
  ...
  domain.Models={
    ...
    'Fflowc_tip10': [  #Flow control with tipping.
      ['lp_pour', 'da_trg','size_srcmouth','material2'
      #  ,'dtheta2'
       ],
