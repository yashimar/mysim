...
def Run(ct, *args):
    log_name_list = [
        "curriculum/pouring3/full_scratch/curriculum_test/t3/first150",
        "curriculum/pouring3/full_scratch/curriculum_test/t3/next150",
    ]
    save_dir = PICTURE_DIR + "curriculum/pouring3/full_scratch/curriculum_test/t3".replace("/","_") + "/"
    save_sh_dir = "curriculum/pouring3/full_scratch/curriculum_test/t3"
    file_name_pref = ""
    ...
    transition_plot(td, log_name_list, dynamics_iodim_pair, vis_state_dynamics_outdim_lim_pair, go_layout, suff_annotation, save_dir, file_name_pref, vis_condition_title_pair, updatemenu)