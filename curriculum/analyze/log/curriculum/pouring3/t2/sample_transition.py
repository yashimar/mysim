...
def Run(ct, *args):
    log_name_list = [
        "curriculum/pouring3/full_scratch/curriculum_test/t2/first150",
        "curriculum/pouring3/full_scratch/curriculum_test/t2/next150",
    ]
    save_dir = PICTURE_DIR + "curriculum/pouring3/full_scratch/curriculum_test/t2".replace("/","_") + "/"
