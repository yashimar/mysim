...
def Run(ct, *args):
    r_types = (R_TRUE, R_EXPEC, R_STD)
    src_path = SRC_PATH + "10_5"
    save_dir = PICTURE_DIR + "curriculum5/c1/trues_sampling/tip_ketchup_smsz_dthtea2".replace("/","_") + "/greedy_opt/{}_{}/".format(10, 5)
    ...
    plotly.offline.plot(fig, filename = save_dir + "optcheck.html", auto_open=False)
