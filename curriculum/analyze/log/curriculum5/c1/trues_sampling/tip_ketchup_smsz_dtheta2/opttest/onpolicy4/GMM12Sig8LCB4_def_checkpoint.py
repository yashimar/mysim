...
def Run(ct,*args):
    ...
    name = "GMM12Sig8LCB4_def/checkpoints/t{}".format(args[0])
    p = 8
    ...
    num_episode = 50
    execute_update(
            start_smsz_select = 10000,
        
            ref_logdir = base_logdir + "logs/onpolicy4/{}/ch100/".format("GMM12Sig8LCB4/checkpoints/t{}".format(args[0])),
    ...
    execute_update(
            ...
            ref_logdir =  base_logdir + "logs/onpolicy4/{}/u{}add{}/".format(name, 1, 50),
