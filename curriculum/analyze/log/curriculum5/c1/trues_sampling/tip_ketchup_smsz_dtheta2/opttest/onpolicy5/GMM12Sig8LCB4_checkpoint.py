...
def Run(ct,*args):
    ...
    execute_checkpoint(
        ...
        base_logdir = base_logdir + "logs/onpolicy5/{}/".format(name),
    )
    
    
    num_ep = 50
    execute_update(
            ref_logdir = base_logdir + "logs/onpolicy5/{}/ch{}/".format(name, num_ep),
            new_logdir = base_logdir + "logs/onpolicy5/{}/u{}add{}/".format(name, 1, num_ep),
