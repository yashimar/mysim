...
def Run(ct, *args):
    log_name_list = [
        "curriculum4/pouring/full_scratch/curriculum_test/t2/first300",
    ]
    save_dir = PICTURE_DIR + "curriculum4/pouring/full_scratch/curriculum_test/t2".replace("/","_") + "/"
    save_sh_dir = "curriculum4/pouring/full_scratch/curriculum_test/t2"
    file_name_pref = ""
