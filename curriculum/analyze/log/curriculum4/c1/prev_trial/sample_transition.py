...
def Run(ct, *args):
    log_name_list = [
        "curriculum4/c1/subtask/t1/first60",
        "curriculum4/c1/maintask/prev_trial/t1/first40",
    ]
    save_dir = PICTURE_DIR + "curriculum4/c1/maintask/prev_trial/t1".replace("/","_") + "/"
    save_sh_dir = "curriculum4/c1/maintask/prev_trial/t1"
    file_name_pref = ""
