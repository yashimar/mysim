...
def Run(ct, *args):
    ...
    file_name_pref = "nobounce_dtheta0014"
    ...
    scatter_condition_title_pair = [
        ...
        ("scatter c2\n0.01*AMP_SMSZ<dtheta2<0.02*AMP_SMSZ", ((0.01*AMP_DTHETA2<=df["dtheta2"])&(df["dtheta2"]<0.02*AMP_DTHETA2))),
        ("scatter c1&c2", ((0.05*AMP_SMSZ<df["size_srcmouth"])&(df["size_srcmouth"]<0.07*AMP_SMSZ) & (0.01*AMP_DTHETA2<=df["dtheta2"])&(df["dtheta2"]<0.02*AMP_DTHETA2))),
