...
def Run(ct, *args):
    ...
    ############################################################################
    suff = "curriculum_test/test3/first80"+"/"
    l.logdir = ROOT_PATH + "curriculum/outflow3/c3"+"/"+suff
    ...
    # l.tasks[-1].config_callback = lambda: custom_config_callback("static",  ("nobounce", "ketchup"), (0.055, 0.07))
    # l.tasks[-1].terminal_condition = lambda count: TerminalCheck(count, 30)
