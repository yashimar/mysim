...
def Domain():  # SpaceDefs and Models (reward function) will be modified by curriculum. (For example, 'action' -> 'state', Rdamount -> Rdaspill, and so on.)
    ...
    domain.Graph = {
        ...
        'n4ti': TDynNode('n3ti', 'P4', ('Rdapour_gentle', 'n4tir1'), ('Rdaspill', 'n4tir2'), ('Rdatotal_gentle', 'n4tir3'), ('Rskill', 'n4tir4')),
        ...
        'n4sa': TDynNode('n3sa', 'P4', ('Rdapour_gentle', 'n4sar1'), ('Rdaspill', 'n4sar2'), ('Rdatotal_gentle', 'n4sar3'), ('Rskill', 'n4sar4')),
