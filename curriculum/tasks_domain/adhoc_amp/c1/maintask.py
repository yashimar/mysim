...
from ..pouring import task_domain as td
...
def Run(ct, *args):
    ...
    ############################################################################
    t_index = 1
    suff = "t"+str(t_index)+"/first40"+"/"
    l.logdir = ROOT_PATH + "curriculum4/c1/maintask"+"/"+suff

    ############################################################################
    # Specify src directory
    ############################################################################
    l.db_src = ROOT_PATH + "curriculum4/c1/subtask/t"+str(t_index)+"/first60"
    l.model_src = ROOT_PATH + "curriculum4/c1/subtask/t"+str(t_index)+"/first60"
    # l.db_src = ""
    # l.model_src = ""
