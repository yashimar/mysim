...
setup_path = 'mysim.curriculum.tasks_domain.detach_amp.c1v3.setup'
AMP_DTHETA2 = 50.
AMP_SMSZ = 10.
AMP_SHAKE_RANGE = 10.
...
def Domain():  # SpaceDefs and Models (reward function) will be modified by curriculum. (For example, 'action' -> 'state', Rdamount -> Rdaspill, and so on.)
    ...
    domain.Models = {
        ...
        'P4':  [[], [PROB_KEY], TLocalLinear(0, 4, lambda x:[1.0]*4, lambda x:[0.0]*4)],
    ...
    domain.Graph = {
        ...
        'n4ti': TDynNode('n3ti2', 'P4', ('Rdapour_gentle', 'n4tir1'), ('Rdaspill', 'n4tir2'), ('Rdatotal_gentle', 'n4tir3'), ('Rskill', 'n4tir4')),
        'n4tir1': TDynNode('n4ti'),
        'n4tir2': TDynNode('n4ti'),
        'n4tir3': TDynNode('n4ti'),
        'n4tir4': TDynNode('n4ti'),
        # Shaking-A:
        'n3sa1': TDynNode('n2c', 'P1', ('Fshake_flow', 'n3sa2')),
        'n3sa2': TDynNode('n3sa1', 'P1', ('Famount', 'n4sa')),
        'n4sa': TDynNode('n3sa2', 'P4', ('Rdapour_gentle', 'n4sar1'), ('Rdaspill', 'n4sar2'), ('Rdatotal_gentle', 'n4sar3'), ('Rskill', 'n4sar4')),
        'n4sar1': TDynNode('n4sa'),
        'n4sar2': TDynNode('n4sa'),
        'n4sar3': TDynNode('n4sa'),
        'n4sar4': TDynNode('n4sa'),
    }
...
def Execute(ct, l):
    ...
    try:
        ...
        CPrint(2, 'Node:', 'n0')
        manual_pourtrgs = [
          SSA(Vec([Rand(0.2, 0.4), Rand(0.1, 0.7)])),
          SSA(Vec([Rand(0.4, 0.6), Rand(0.2, 0.4)])),
          SSA(Vec([Rand(0.5, 0.7), Rand(0.1, 0.3)])),
          SSA(Vec([Rand(0.6, 0.8), Rand(0.1, 0.3)])),
          SSA(Vec([Rand(0.5, 0.7), Rand(0.5, 0.7)])),
          SSA(Vec([Rand(0.7, 1.0), Rand(0.3, 0.5)])),
          SSA(Vec([Rand(1.0, 1.2), Rand(0.2, 0.6)])),
        ]
        ...
        l.xs.n0['p_pour_trg'] = manual_pourtrgs[RandI(len(manual_pourtrgs))]
        ...
        l.dpl.MM.Models['Fgrasp'][2].Options.update(l.nn_options['Fgrasp'])
        ...
        l.dpl.MM.Models['Fmvtorcv_rcvmv'][2].Options.update(l.nn_options['Fmvtorcv_rcvmv'])
        ...
        l.dpl.MM.Models['Fmvtorcv'][2].Options.update(l.nn_options['Fmvtorcv'])
        ...
        while True:  # Try-and-error starts from here.
            ...
            l.dpl.MM.Models['Fmvtopour2'][2].Options.update(l.nn_options['Fmvtopour2'])
            ...
            if selected_skill == 'tip':
                ...
                l.dpl.MM.Models['Ftip_amount'][2].Options.update(l.nn_options['Ftip_amount'])
                ...
                l.dpl.MM.Models['Ftip_flow'][2].Options.update(l.nn_options['Ftip_flow'])
                ...
                l.dpl.MM.Models['Famount'][2].Options.update(l.nn_options['Famount'])
                ...
                ############################################################################
                # n4tir3: Calculate Rdatotal_gentle
                ############################################################################
                CPrint(2, 'Node:', 'n4tir3')
                l.xs.n4tir3 = l.dpl.Forward('Rdatotal_gentle', l.xs.prev)
                l.idb.n4tir3 = l.dpl.DB.AddToSeq(parent=l.idb.prev, name='n4tir3', xs=l.xs.n4tir3)
                
                ############################################################################
                # n4tir4: Calculate Rskill
                ############################################################################
                CPrint(2, 'Node:', 'n4tir4')
                l.xs.n4tir4 = l.dpl.Forward('Rskill', l.xs.prev)
                l.idb.n4tir4 = l.dpl.DB.AddToSeq(parent=l.idb.prev, name='n4tir4', xs=l.xs.n4tir4)
                ...
                l.dpl.MM.Models['Fshake_amount'][2].Options.update(l.nn_options['Fshake_amount'])
                ...
                l.dpl.MM.Models['Fshake_flow'][2].Options.update(l.nn_options['Fshake_flow'])
                ...
                ############################################################################
                # n4sar3: Calculate Rdatotal_gentle
                ############################################################################
                CPrint(2, 'Node:', 'n4sar3')
                l.xs.n4sar3 = l.dpl.Forward('Rdatotal_gentle', l.xs.prev)
                l.idb.n4sar3 = l.dpl.DB.AddToSeq(parent=l.idb.prev, name='n4sar3', xs=l.xs.n4sar3)
                
                ############################################################################
                # n4sar4: Calculate Rskill
                ############################################################################
                CPrint(2, 'Node:', 'n4sar4')
                l.xs.n4sar4 = l.dpl.Forward('Rskill', l.xs.prev)
                l.idb.n4sar4 = l.dpl.DB.AddToSeq(parent=l.idb.prev, name='n4sar4', xs=l.xs.n4sar4)
