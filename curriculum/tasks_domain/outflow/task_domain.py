...
def Domain():  # SpaceDefs and Models (reward function) will be modified by curriculum. (For example, 'action' -> 'state', Rdamount -> Rdspill, and so on.)
    ...
    domain.Models = {
        ...
        "Routflow": [['da_trg', "da_total"], [REWARD_KEY], Routflow()],
    ...
    domain.Graph = {
        ...
        'n4ti': TDynNode('n3ti', 'P1', ('Routflow', 'n4tir')),
        'n4tir': TDynNode('n4ti'),
        # Shaking-A:
        'n3sa': TDynNode('n2c', 'P1', ('Famount', 'n4sa')),
        'n4sa': TDynNode('n3sa', 'P1', ('Routflow', 'n4sar')),
        'n4sar': TDynNode('n4sa'),
    }
    ...
    try:
        ...
        while True:  # Try-and-error starts from here.
            ...
            if selected_skill == 'tip':
                ...
                ############################################################################
                # n4tir: Calculate Routflow
                ############################################################################
                CPrint(2, 'Node:', 'n4tir')
                l.xs.n4tir = l.dpl.Forward('Routflow', l.xs.prev)
                ...
                ############################################################################
                # n4sar: Caluculate Routflow
                ############################################################################
                CPrint(2, 'Node:', 'n4sar')
                l.xs.n4sar = l.dpl.Forward('Routflow', l.xs.prev)
