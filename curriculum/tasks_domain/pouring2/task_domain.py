...
setup_path = 'mysim.curriculum.tasks_domain.pouring2.setup'
...
def Domain():  # SpaceDefs and Models (reward function) will be modified by curriculum. (For example, 'action' -> 'state', Rdamount -> Rdaspill, and so on.)
    ...
    domain.Models = {
        ...
        "Rdapour": [['da_trg', 'da_pour'], [REWARD_KEY], Rmodel("Fdapour")],
    ...
    domain.Graph = {
        ...
        'n4ti': TDynNode('n3ti', 'P1', ('Rdapour', 'n4tir1')),
        'n4tir1': TDynNode('n4ti', 'P1', ('Rdaspill', 'n4tir2')),
        'n4tir2': TDynNode('n4tir1'),
        # Shaking-A:
        'n3sa': TDynNode('n2c', 'P1', ('Famount', 'n4sa')),
        'n4sa': TDynNode('n3sa', 'P1', ('Rdapour', 'n4sar1')),
        'n4sar1': TDynNode('n4sa', 'P1', ('Rdaspill', 'n4sar2')),
        'n4sar2': TDynNode('n4sar1'),
    }
    ...
    try:
        ...
        while True:  # Try-and-error starts from here.
            ...
            if selected_skill == 'tip':
                ...
                ############################################################################
                # n4tir1: Calculate Rdapour
                ############################################################################
                CPrint(2, 'Node:', 'n4tir1')
                l.xs.n4tir1 = l.dpl.Forward('Rdapour', l.xs.prev)
                ...
                ############################################################################
                # n4sar1: Caluculate Rdapour
                ############################################################################
                CPrint(2, 'Node:', 'n4sar1')
                l.xs.n4sar1 = l.dpl.Forward('Rdapour', l.xs.prev)
