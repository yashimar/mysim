from ..util import CreatePredictionLog, CurrentPredict
...
setup_path = 'mysim.curriculum.tasks_domain.outflow2.setup'
...
def Domain():  # SpaceDefs and Models (reward function) will be modified by curriculum. (For example, 'action' -> 'state', Rdamount -> Rdspill, and so on.)
    ...
    domain.SpaceDefs = {
        ...
        'p_pour_trg': SP('state', 2, min=[0.2, 0.1], max=[1.2, 0.7]),  # Target pouring axis position (x,z)
    ...
    domain.Models = {
        ...
        "Rdatotal": [['da_trg', "da_total"], [REWARD_KEY], Rmodel("Fdatotal")],
    ...
    domain.Graph = {
        ...
        'n4ti': TDynNode('n3ti', 'P2', ('Rdatotal', 'n4tir1'), ('Rskill', 'n4tir2')),
        'n4tir1': TDynNode('n4ti'),
        'n4tir2': TDynNode('n4ti'),
        # Shaking-A:
        'n3sa': TDynNode('n2c', 'P1', ('Famount', 'n4sa')),
        'n4sa': TDynNode('n3sa', 'P2', ('Rdatotal', 'n4sar1'), ('Rskill', 'n4sar2')),
    ...
    try:
        ...
        while True:  # Try-and-error starts from here.
            ...
            if selected_skill == 'tip':
                ...
                ############################################################################
                # n4tir1: Calculate Rdatotal
                ############################################################################
                CPrint(2, 'Node:', 'n4tir1')
                l.xs.n4tir1 = l.dpl.Forward('Rdatotal', l.xs.prev)
                ...
                ############################################################################
                # n4sar: Caluculate Rdatotal
                ############################################################################
                CPrint(2, 'Node:', 'n4sar1')
                l.xs.n4sar1 = l.dpl.Forward('Rdatotal', l.xs.prev)
