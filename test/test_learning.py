...
def Execute(ct,l):
  ...
  with sim.TPause(ct):  #Pause during plan/learn
    ...
    # CPrint(3,len(l.dpl.DB.Entry))
    # CPrint(3,l.dpl.MM.Models["Fgrasp"][2].NSamples)
    CPrint(3,l.dpl.MM.Models["Fgrasp"][2].Params['nn_data_x'])
    CPrint(3,len(l.dpl.MM.Models["Fgrasp"][2].DataX))
    # CPrint(3,l.dpl.MM.Models["Fgrasp"][2].DataX)
    l.dpl.MM.Models["Fgrasp"][2].Update(None,None,not_learn=l.not_learn)
...
def Run(ct,*args):
  ...
  l.logdir= '/tmp/learn_dynamics_dpl3/'
  opt_conf={
  ...
  if 'log_dpl' in ct.__dict__ and (CPrint(1,'Restart from existing DPL?'), AskYesNo())[1]:
    ...
    # CPrint(3,mm.Models["Fgrasp"][2].Options['base_dir'])
    # mm.Models["Fgrasp"][2].Options['base_dir'] = "/tmp/"
  ...
  # l.dpl.MM.Models["Fgrasp"][2].Options['base_dir'] = "/hoge/"
  # Print(l.dpl.MM.Options)
  # l.dpl.MM.Models["Fgrasp"][2].Load(None, "/tmp/dpl2_shake_A11311/models/Fgrasp_")
  # Print(l.dpl.MM.Options)
  # l.dpl.MM.Options['base_dir'] = "/hoge/"
  

  if not l.restarting:
    CPrint(3,l.dpl.MM.Options['base_dir'])
    CPrint(3,l.dpl.MM.Models["Fgrasp"][2].Options['base_dir'])
    CPrint(3,l.dpl.MM.Models["Fgrasp"][2].load_base_dir)
    l.dpl.MM.Init()
    # CPrint(2,len(l.dpl.MM.Models["Fgrasp"][2].DataX),l.dpl.MM.Models["Fgrasp"][2].DataX)
    # l.dpl.MM.Models["Fgrasp"][2].DataX = np.concatenate([l.dpl.MM.Models["Fgrasp"][2].DataX, 
    #                                                 l.dpl.MM.Models["Fgrasp"][2].DataX])
    # l.dpl.MM.Models["Fgrasp"][2].DataY = np.concatenate([l.dpl.MM.Models["Fgrasp"][2].DataY, 
    #                                                     l.dpl.MM.Models["Fgrasp"][2].DataY])
    # CPrint(2,len(l.dpl.MM.Models["Fgrasp"][2].DataX))
    l.dpl.Init()
    print("----")
    # change DataX, DataY, nn_params, nn_params_err
    load_base_dir = "/tmp/dpl2_shake_A11311/models/"
    skill = "Fgrasp_"
    path = load_base_dir + skill + 'nn_data_x.dat'
    dataX = np.array(pickle.load(open(path, 'rb')), np.float32)
    l.dpl.MM.Models["Fgrasp"][2].DataX = dataX
    # l.dpl.MM.Models["Fgrasp"][2].Load(None, "/tmp/dpl2_shake_A11311/models/Fgrasp_")
    # l.dpl.MM.Models["Fgrasp"][2].Init()
