...
def OpenWCheck(file_name, mode, interactive=False):
...
def OpenW(file_name, mode='w', interactive=False):
...
def DualWriter(file_name,interactive=False):
...
def WriteVarToFile(x, file_name, except_cnv=lambda y:y, interactive=False):
