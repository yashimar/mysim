...
def Run(ct, *args):
    ...
    # ct.Run('mysim.curriculum.analyze.log.curriculum2.pouring.t1.sample_transition')
    # ct.Run('mysim.curriculum.analyze.log.curriculum2.pouring.t2.sample_transition')
    # ct.Run('mysim.curriculum.analyze.log.curriculum2.pouring.t3.sample_transition')
    # ct.Run('mysim.curriculum.analyze.log.curriculum.pouring3.t1.sample_transition')
    # ct.Run('mysim.curriculum.analyze.log.curriculum.pouring3.t2.sample_transition')
    # ct.Run('mysim.curriculum.analyze.log.curriculum.pouring3.t3.sample_transition')