...
def Run(ct,*args):
  ...
  l.logdir= args[0] if len(args)>0 else '/tmp/learn_grab/'
  ...
  l.logdir= '/home/yashima/ros_ws/ay_tools/ay_skill_extra/mysim/logs/learn_dynamics2'
  opt_conf={
  ...
  domain.Graph={
    ...
    'n2b': TDynNode('n2a','P1',('Rmvtopour','n2br')),
    'n2br': TDynNode('n2b'),
