...
def Run(ct,*args):
  file_name = "r100_mc10_cfm2_erp8_log"
  path = "/home/yashima/ros_ws/ay_tools/ay_skill_extra/mysim/debug/" \
          + file_name + ".txt"
  with open(path) as f:
    data = f.readlines()
  ...
  fig.suptitle("sensor x_rcv value" + " (MaxContacts 10, ContactSoftCFM 1e-2, ContactSoftERP 0.8)")
